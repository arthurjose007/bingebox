      ...
      child: Consumer<HomePageProvider>(
        builder: (context, homeProvider, child) {
          ...
          return Scaffold(
            ...
            body:
                homeProvider.popularMovieerrrormessage.isNotEmpty ||
                    homeProvider.upcomingerrrormessage.isNotEmpty
                ? Center(
                    child: Text(
                      homeProvider.popularMovieerrrormessage,
                                ...
                                : Column(
                                    children: [
                                      ComingSoon(
                                        ...
                                        overview: movieListData[index].overview
                                            .toString(),
                                        logoUrl:
